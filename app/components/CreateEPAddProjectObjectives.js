...
export default class CreateEPAddProjectObjectives extends React.Component {
  ...
  showPrevProjectItem = () =>
    this.setState((prevState) => ({
      selectedProjectItemIdx: prevState.selectedProjectItemIdx
        ...
        : this.props.engagementPlan.project_items.size - 1,
    }));

  showNextProjectItem = () =>
    this.setState((prevState) => ({
      selectedProjectItemIdx:
        prevState.selectedProjectItemIdx <
        this.props.engagementPlan.project_items.size - 1
          ? prevState.selectedProjectItemIdx + 1
          : 0,
    }));
  ...
  render() {
    ...
    const projectItem = engagementPlan.project_items.get(
      this.state.selectedProjectItemIdx
    );
      ...
      <div className="CreateEPAddProjectObjectives">
        ...
        {projectItem && (
          <div
            ...
            className="CreateEPAddProjectObjectives__projectItem"
          >
            <Panel className="CreateEPAddProjectObjectives__projectItem__project">
              <Panel.Body>
                <Button
                  onClick={this.showPrevProjectItem}
                  className="pull-left"
                >
                  &lt;
                </Button>
                <Button
                  onClick={this.showNextProjectItem}
