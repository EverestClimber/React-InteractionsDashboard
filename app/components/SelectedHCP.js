...
const SelectedHCP = ({ hcp, handleRemove, children }) => ( // eslint-disable-line react/prop-types
  <Panel
    className={`SelectedHCP SelectedHCP--${hcp.has_consented ? 'consentYes' : 'consentNo'}`}
  >
    <Panel.Body>
      <div className="SelectedHCP__heading">
        ...
        <span
          className={`SelectedHCP__consent SelectedHCP__consent--${hcp.has_consented ? 'yes' : 'no'}`}
        >
      ...
      <div className="SelectedHCP__location location">
        ...
        <span className="SelectedHCP__location__city">
          {hcp.city}
        </span>
        {', '}
      ...
      <div className="SelectedHCP__tas">
        {hcp.ta_names.join(', ')}
      </div>
      ...
      {children && (
        <div className="SelectedHCP__children">
          {children}
        </div>
      )}
    </Panel.Body>
